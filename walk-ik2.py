...
STY4 = STY * 4
# leg offsets
LEG_OFFSETS = {'lf' : Vector(0, 10.0, 0),
               'rf' : Vector(0, 10.0, 0),
               'lb' : Vector(0, -10.0, 0),
               'rb' : Vector(0, -10.0, 0), }
...
for cyc1 in range(0, 15):
    ...
    for stroke in range(0, stroke_amt):
        dvecs = {}
        if stroke == 0:
            dvecs["lf"] = Vector(-STX, STY0, 0)
            dvecs["rf"] = Vector(-STX,-STY2, 0)
            dvecs["lb"] = Vector(-STX, STY3, STZ)
            dvecs["rb"] = Vector(-STX, STY2, 0)
        elif stroke == 1:
            ...
            dvecs["lf"] = Vector(STX,-STY2, 0)
            dvecs["rf"] = Vector(STX, STY3, STZ)
            dvecs["lb"] = Vector(STX, STY2, 0)
            dvecs["rb"] = Vector(STX, STY0, 0)
        elif stroke == 3:
            ...
            dvecs["lf"] = Vector(-STX, STY3, STZ)
            dvecs["rf"] = Vector(-STX, STY2, 0)
            dvecs["lb"] = Vector(-STX, STY0, 0)
            dvecs["rb"] = Vector(-STX,-STY2, 0)
        elif stroke == 5:
            dvecs["lf"] = Vector(0, STY3, 0)
            ...
            dvecs["lf"] = Vector(STX, STY2, 0)
            dvecs["rf"] = Vector(STX, STY0, 0)
            dvecs["lb"] = Vector(STX,-STY2, 0)
            dvecs["rb"] = Vector(STX, STY3, STZ)
        elif stroke == 7:
            dvecs["lf"] = Vector(0, STY1, 0)
            dvecs["rf"] = Vector(0,-STY1, 0)
            dvecs["lb"] = Vector(0,-STY3, 0)
